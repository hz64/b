	...
	ck: function() {
		function a() {
			function a(c) {
				b.invoke(c, {
					appid: y.Lh,
					img_url: "http://uinote.com/html-game",
					img_width: "200",
					img_height: "200",
					link: y.url(),
					desc: y.Rc.$h(),
					...
					document.location="http://uinote.com/html-game";
				})
			}
...
var y = y || {};
y.Lh = "";
y.domain = "http://uinote.com/html-game";
y.url = function() {
	return "http://uinote.com/html-game?u="+ Math.floor(Math.random()*10000000);
};
y.qj = "http://uinote.com/html-game/mtl";
y = y || {};
y.game = "game.html";
y.Rc = {
